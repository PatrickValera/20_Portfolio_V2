  ...
  return (
    <Box display='flex' sx={{ height: '100vh', alignItems: 'center',alignContent:'center',gap:4, justifyContent:'center',flexWrap:'wrap' }}>
      <Box className='fade'sx={{ pl:4,flexGrow:'1'}}>
        ...
        <Typography variant='body1' sx={{maxWidth:'450px'}} gutterBottom> A Software Engineer student and a self-taught web developer. I aim to deepen my understanding of various technologies and build exceptional products.</Typography>
