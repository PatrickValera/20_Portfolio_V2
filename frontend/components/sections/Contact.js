  ...
  return (
    <Box id='contact' sx={{ mb: '15vh' }}>
      <Fade sx={{ alignItems: 'center', display: 'flex', flexDirection: 'column' }}>
        ...
        <Typography variant='body1' sx={{ mb: 2 ,textAlign:'center'}}>{`I am curently looking for new opportunites and I'm open for work.`}<br/> {`Send me a message and I'll get back to you.`}</Typography>
